...
class App extends Component {
  ...
  dealCards(){
    this.setState({
      cards: shuffledDeck.splice(0,47),
    })
  }
  render() {
    // array to hold JSX elements
    let cardsImage = "http://golearntocode.com/images/cards/" + this.state.hand + ".png";
    let handImage = "http://golearntocode.com/images/cards/" + this.state.cards + ".png";
    let cards = ["http://golearntocode.com/images/cards/" + this.state.cards + ".png"];
    return (
      <div className="App">
      <h1>
      <img src= {cardsImage}/>
      <img src= {handImage}/>
        ...
        <p><button>{()=>this.dealCards()}>Deal New Cards</button></p>
      </div>
    );
  }
}
